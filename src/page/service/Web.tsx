...
import SliderLaptop from "../../component/SliderLaptop";
    ...
    <>
      ...
      <section className="txt-center px-6 container h-min-100vh flex align-middle justify-center">
        <div className="mt-6">
          ...
          <div className="is-lg">We develop Web apps that help businesses for better operational efficiency and engagement. Hire certified Web app developers from QuellXCode who are experts for delivering excellence in Android, iOS and cross-platform app development services.</div>
        </div>
      </section>
      ...
      <section>
        <div className="py-2 container grid has-gap-lg align-middle">
          <div className="column pr-2">
            ...
            <div className="txt-justify">QuellXCode is a top iOS/ iPhone app development company that boasts a talented pool of expert iOS developers. We help our clients with custom applications that work perfectly on the entire iOS platform including the latest and the most recent iOS versions and iOS devices like iPhones, iPads, Apple Watches, Apple TV, etc. Hire iOS app developers with years of experience with the latest iOS app development technologies to build Web apps with delightful UX.</div>
        ...
        <div className="py-2 container grid has-gap-lg align-middle">
          <div className="column pr-2">
            <h1>Web Apps Driven by Cloud</h1>
            ...
            <div>
              <button className="btn is-box inline-flex align-middle justify-center my-2 mx-7px" style={{ width: "50px", height: "50px" }}>
                <i className="inline-flex align-middle ri-2x">
                  <img className="img" src="https://d1i2cp4a5c819e.cloudfront.net/wp-content/uploads/2020/01/ic-technology-amazon-web-services.svg" alt="ionic" />
                </i>
              </button>
              <button className="btn is-box inline-flex align-middle justify-center my-2 mx-7px" style={{ width: "50px", height: "50px" }}>
                <i className="inline-flex align-middle ri-2x">
